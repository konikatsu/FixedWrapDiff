...
固定長テキスト確認を補助する関連ツールも公開しています。

- [SpaceRunViewer](https://github.com/konikatsu/SpaceRunViewer): テキスト内の連続した空白部分を検出し、開始桁と文字数を一覧表示するツール
- [FixedDataBuilder](https://github.com/konikatsu/FixedDataBuilder): 固定長データの作成や確認を支援するツール
...
![FixedWrapDiff line only screenshot](assets/screenshot-line-only.png)
