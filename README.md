...
このリポジトリには、固定長テキスト確認を補助する別ツールも含めています。

- [SpaceRunViewer](SpaceRunViewer/README.md): テキスト内の連続した空白部分を検出し、開始桁と文字数を一覧表示するツール

## ダウンロード

最新版は GitHub Releases からダウンロードできます。

[FixedWrapDiff-v0.4.0-win-x64.zip をダウンロード](https://github.com/konikatsu/FixedWrapDiff/releases/download/v0.4.0/FixedWrapDiff-v0.4.0-win-x64.zip)
